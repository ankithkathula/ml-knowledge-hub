import svgPaths from "./svg-0sqqs9l6op";
...
function ImageMaterialLibrary() {
  return (
    <div className="absolute h-[40px] left-[47.5px] top-[128px] w-[171.938px]" data-name="Image (Material Library)">
...
function Container() {
  return <div className="absolute bg-[#ff7a59] h-[2px] left-0 top-[34px] w-[70.828px]" data-name="Container" />;
}
...
function Container1() {
  return (
    <div className="absolute h-[37px] left-[47.5px] top-[216px] w-[364.797px]" data-name="Container">
...
function Heading() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Satoshi',sans-serif] leading-[40px] left-0 not-italic text-[#101828] text-[36px] text-nowrap top-px whitespace-pre">Welcome!</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Satoshi',sans-serif] leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-px w-[328px]">Please enter your details below. Sign in using email or phone number.</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[92px] items-start left-[47.5px] top-[285px] w-[364.797px]" data-name="Container">
      <Heading />
      <Paragraph />
    </div>
  );
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[58.422px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[58.422px]">
        <p className="absolute font-['Satoshi',sans-serif] leading-[20px] left-0 not-italic text-[#364153] text-[14px] text-nowrap top-px whitespace-pre">Password</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="h-[16px] relative shrink-0 w-[93.703px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[16px] items-start relative w-[93.703px]">
        <p className="font-['Satoshi',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#6a7282] text-[12px] text-center text-nowrap whitespace-pre">Forgot password?</p>
      </div>
    </div>
  );
}
...
function PasswordInput() {
  return (
    <div className="absolute bg-white h-[46px] left-0 rounded-[10px] top-0 w-[364.797px]" data-name="Password Input">
      <div className="box-border content-stretch flex h-[46px] items-center overflow-clip pl-[16px] pr-[48px] py-[12px] relative rounded-[inherit] w-[364.797px]">
...
function Button3() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[328.8px] size-[20px] top-[13px]" data-name="Button">
      <Icon2 />
    </div>
  );
}
...
function Button4() {
  return (
    <div className="absolute bg-[#ff7a59] h-[48px] left-0 rounded-[10px] top-0 w-[364.797px]" data-name="Button">
      <p className="absolute font-['Satoshi',sans-serif] leading-[20px] left-[182.73px] not-italic text-[14px] text-center text-nowrap text-white top-[15px] translate-x-[-50%] whitespace-pre">Log In</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute h-[24px] left-[240.77px] top-0 w-[53.391px]" data-name="Button">
      <p className="[text-underline-position:from-font] absolute decoration-solid font-['Satoshi',sans-serif] leading-[24px] left-[27px] not-italic text-[#ff7a59] text-[16px] text-center text-nowrap top-px translate-x-[-50%] underline whitespace-pre">Sign up</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-0 top-[64px] w-[364.797px]" data-name="Paragraph">
      <p className="absolute font-['Satoshi',sans-serif] leading-[20px] left-[156.13px] not-italic text-[#6a7282] text-[14px] text-center top-[4px] translate-x-[-50%] w-[171px]">{`Don't have an account yet?`}</p>
      <Button5 />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="h-[88px] relative shrink-0 w-[364.797px]" data-name="Container">
      <Button4 />
      <Paragraph1 />
    </div>
  );
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[539.141px] items-start left-0 top-0 w-[364.797px]" data-name="Container">
      <Container3 />
      <Container6 />
      <Container7 />
    </div>
...
function Form() {
  return (
    <div className="absolute h-[659.141px] left-[47.5px] top-[409px] w-[364.797px]" data-name="Form">
      <Container8 />
    </div>
  );
}
...
export default function MaterialLibraryDesign() {
  return (
    <div className="bg-white relative size-full" data-name="MATERIAL LIBRARY design 7">
      <App />
      <Header2 />
    </div>
  );
