import svgPaths from "./svg-iv7vcyq324";
import imgBrandsPage from "figma:asset/ca5428909333f4c4f971f236d54995fefadf0bc1.png";
import imgImage27 from "figma:asset/146c45cee0a4ddf1a766c4f798780ea8bbad5f99.png";
...
function BrandsPage2() {
  return (
    <div className="absolute bg-white h-[2706.39px] left-0 overflow-clip top-0 w-[1903px]" data-name="BrandsPage">
      <Section />
      <Container2 />
      <div className="absolute h-[739px] left-[25px] top-[792px] w-[1820px]" data-name="image 27">
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p16991b00} id="Vector" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p3a5e5a00} id="Vector_2" stroke="var(--stroke-0, #6A7282)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="basis-0 grow h-[16px] min-h-px min-w-px relative shrink-0" data-name="Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16px] overflow-clip relative rounded-[inherit] w-full">
        <div className="absolute inset-[33.33%_33.33%_33.34%_33.34%]" data-name="Vector">
        ...
        <div className="absolute bottom-[83.34%] left-1/2 right-1/2 top-[8.33%]" data-name="Vector">
        ...
        <div className="absolute bottom-[8.34%] left-1/2 right-1/2 top-[83.33%]" data-name="Vector">
          <div className="absolute inset-[-50%_-0.67px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 3">
              <path d="M0.666667 0.666667V2" id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </svg>
        ...
        <div className="absolute bottom-1/2 left-[8.34%] right-[83.33%] top-1/2" data-name="Vector">
        ...
        <div className="absolute bottom-1/2 left-[83.34%] right-[8.33%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-0.67px_-50%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 2">
              <path d="M0.666667 0.666667H2" id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            </svg>
  ...
  return (
    <div className="absolute left-[8px] size-[20px] top-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_4192_138)" id="Icon">
          <path d={svgPaths.p29ec9280} id="Vector" stroke="var(--stroke-0, #364153)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1b418400} id="Vector_2" stroke="var(--stroke-0, #364153)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p26f10d00} id="Vector_3" stroke="var(--stroke-0, #364153)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
          <clipPath id="clip0_4192_138">
...
export default function MaterialLibraryDesign() {
  return (
    <div className="bg-white relative size-full" data-name="MATERIAL LIBRARY design 13">
      <BrandsPage2 />
      <Header2 />
    </div>
  );
