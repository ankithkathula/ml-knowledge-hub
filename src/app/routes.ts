...
import { InstituteMicrositePage } from "./components/pages/InstituteMicrositePage";
...
import { BrandStoresPage } from "./components/brand_dashboard/BrandStoresPage";
...
// ── Shared Analytics ──
import { DashboardAnalyticsPage } from "./components/shared/DashboardAnalyticsPage";
...
// Strip the trailing slash from Vite's BASE_URL so React Router's basename is e.g.
// "/ml-knowledge-hub" in production and "/" in dev — keeps deep links working under
...
export const router = createBrowserRouter([
  // ── Public site (global Navbar + Footer via PublicLayout) ──
  {
    ...
    children: [
      ...
      { path: "/institute-microsite/:instituteId", Component: InstituteMicrositePage },
  ...
  // ── Designer Dashboard ──
  {
    ...
    children: [
      ...
      { path: "analytics",      Component: DashboardAnalyticsPage },
  ...
  // ── Brand Dashboard ──
  {
    ...
    children: [
      ...
      { path: "stores",         Component: BrandStoresPage },
    ],
  },
