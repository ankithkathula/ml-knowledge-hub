...
const RAW_PRODUCTS: Product[] = [
  ...
  // ========== KAJARIA — TILES, SLABS & SANITARYWARE ==========
  { id: 'kaj1', name: 'Eternity Glazed Vitrified Tile', brand: 'Kajaria', productFamily: 'Eternity Series', category: 'flooring', subcategory: 'tiles', productType: 'vitrified-tiles', grade: 'GVT', materialType: 'Glazed Vitrified Tile', packaging: 'Box of 4 (2.88 sq.m)', certifications: ['ISO 13006', 'GreenPro'], features: ['High Gloss Finish', 'Scratch Resistant', 'Low Water Absorption'], application: ['Living Room Flooring', 'Commercial Spaces'], stock: 'In Stock', image: '', price: '₹78/sq ft', badge: 'Top Seller', availableCities: ['Pan India'], priceType: 'fixed' },
  { id: 'kaj2', name: 'Marbonite Double Charge Tile', brand: 'Kajaria', productFamily: 'Marbonite Series', category: 'flooring', subcategory: 'tiles', productType: 'vitrified-tiles', grade: 'Double Charge', materialType: 'Double Charge Vitrified Tile', packaging: 'Box of 4 (2.88 sq.m)', certifications: ['ISO 13006'], features: ['Heavy-Traffic Durable', 'Through-Body Colour', 'Marble Look'], application: ['Lobbies', 'Showrooms', 'Commercial Flooring'], stock: 'In Stock', image: '', price: '₹95/sq ft', badge: 'Premium', availableCities: ['Pan India'], priceType: 'fixed' },
  { id: 'kaj3', name: 'Vintage Wood-Plank Vitrified Tile', brand: 'Kajaria', productFamily: 'Vintage Series', category: 'flooring', subcategory: 'tiles', productType: 'wood-plank-tiles', grade: 'GVT', materialType: 'Wood-Look Vitrified Tile', packaging: 'Box of 5', certifications: ['ISO 13006'], features: ['Realistic Wood Grain', 'Anti-Slip', 'Easy Maintenance'], application: ['Bedrooms', 'Cafes', 'Boutique Retail'], stock: 'In Stock', image: '', price: '₹70/sq ft', badge: 'New Launch', priceType: 'fixed' },
  { id: 'kaj4', name: 'Kerastar Anti-Skid Outdoor Tile', brand: 'Kajaria', productFamily: 'Kerastar Series', category: 'flooring', subcategory: 'tiles', productType: 'outdoor-tiles', grade: 'Full Body', materialType: 'Anti-Skid Porcelain Tile', packaging: 'Box of 4', certifications: ['ISO 13006', 'R11 Slip Rating'], features: ['R11 Anti-Skid', 'Frost Resistant', 'Full-Body Strength'], application: ['Balconies', 'Patios', 'Pool Decks'], stock: 'In Stock', image: '', price: '₹68/sq ft', priceType: 'fixed' },
  { id: 'kaj5', name: 'Bathonix Sanitaryware Suite', brand: 'Kajaria', productFamily: 'Bathonix Series', category: 'sanitary', subcategory: 'sanitaryware', materialType: 'Vitreous China Sanitaryware', packaging: 'Per piece / suite', certifications: ['IS 2556', 'WaterSense'], features: ['Rimless Flush Design', 'Anti-Bacterial Glaze', 'Water Efficient'], application: ['Bathrooms', 'Hospitality Washrooms'], stock: 'Made to Order', image: '', price: '₹6,500/suite', badge: 'Premium', priceType: 'quote' },
];
