            ...
            {viewingJob.applicants.length === 0 ? (
              ...
              <div className="p-5">
                ...
                <div className="glass-card !p-5">
                  ...
                  <div className="flex items-center gap-4 mb-5">
                    <AvatarImg src={selectedApplicant.avatarUrl} fallback={selectedApplicant.avatar} size={56} />
              ...
              <div className="p-5 space-y-3">
                {viewingJob.applicants.map((applicant) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <AvatarImg src={applicant.avatarUrl} fallback={applicant.avatar} size={40} />
                      <div className="flex-1 min-w-0">
