...
import {
  ...
  Newspaper, Users, BarChart3, Upload, PenTool, ChevronLeft,
  ChevronRight, Zap, LogOut, Settings, Menu, X, UserCircle,
  CalendarCheck, Briefcase, GraduationCap
} from "lucide-react";

const ADMIN_NAV = [
  { label: "Dashboard", href: "/admin", icon: LayoutDashboard },
  { label: "Taxonomy (L1-L5)", href: "/admin/taxonomy", icon: Network },
  ...
  { label: "Market Data", href: "/admin/market-data", icon: BarChart3 },
      ...
      <div className="px-2 pb-3 flex-shrink-0" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
        <div className="pt-3 space-y-0.5">
          ...
          >
            ...
            {!collapsed && <span style={{ fontSize: "0.82rem" }}>Settings</span>}
          </Link>
          <Link
            to="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all"
