...
import { ArrowRight, Search, GitCompare, BookmarkPlus, FileText, Users, Layers, ChevronRight } from 'lucide-react';
import { MainFooter } from './MainFooter';

interface StudiosLandingPageProps {
  onNavigate?: (page: string) => void;
}

export function StudiosLandingPage({ onNavigate }: StudiosLandingPageProps) {
  const capabilities = [
    {
      icon: <Search className="w-5 h-5" />,
      title: "Discover Verified Products",
      desc: "Access a curated database of construction materials with verified specifications"
    },
    {
      icon: <GitCompare className="w-5 h-5" />,
      title: "Compare Materials",
      desc: "Side-by-side comparison tools for informed material selection decisions"
    },
    {
      icon: <BookmarkPlus className="w-5 h-5" />,
      title: "Save to Projects",
      desc: "Organize materials into project-specific collections and boards"
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Access Technical Specifications",
      desc: "Download datasheets, certifications, and technical documentation instantly"
    },
    {
      icon: <Users className="w-5 h-5" />,
      title: "Connect with Brands",
      desc: "Direct communication channels with manufacturers and suppliers"
    },
    {
      icon: <Layers className="w-5 h-5" />,
      title: "Manage Team Collaboration",
      desc: "Invite team members and collaborate on material specifications"
    }
  ];

  const howItWorksSteps = [
    { number: 1, title: "Create Profile", desc: "Set up your studio account with portfolio and team details" },
    { number: 2, title: "Explore Materials", desc: "Browse verified products across all categories" },
    { number: 3, title: "Organize Projects", desc: "Create boards and save materials to projects" },
    { number: 4, title: "Collaborate", desc: "Connect with brands and streamline procurement" }
  ];

  const benefits = [
    "Access to verified material database with technical specs",
    "Streamlined material specification workflow",
    "Direct communication with brand representatives",
    "Project-based material organization system",
    "Team collaboration and approval workflows",
    "Priority support for studio partners"
  ];
    ...
    <div className="min-h-screen bg-white font-['Satoshi',sans-serif]">
      ...
      <div className="pt-24 pb-4 px-4 md:px-8 max-w-[1200px] mx-auto">
        <div className="flex items-center gap-2 text-[11px] text-gray-500 uppercase tracking-wider">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-[#FF6A3D]">Studios</span>
        </div>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight mb-6 leading-[1.1]">
              Discover Verified Materials and Manage Projects Efficiently
            </h1>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Access trusted brands, compare materials, and streamline project workflows from one unified platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Join as Studio <ArrowRight className="w-4 h-4" />
              </button>
              <button 
          ...
          >
            <div className="text-center text-gray-400">
              ...
              <p className="text-sm uppercase tracking-wider">Studio Dashboard Preview</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Professional tools designed for architecture and design studios
            </p>
          </motion.div>
        ...
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="text-center text-gray-500">
              ...
              <p className="text-xs uppercase tracking-wider">Project Management Dashboard</p>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-3xl font-normal tracking-tight mb-6">
              Streamlined Studio Workflows
            </h2>
            <div className="space-y-4">
              {[
                "Project-based material organization boards",
                "Advanced search and filtering capabilities",
                "Material comparison tools with detailed specs",
                "Direct messaging with brand representatives",
                "Team member access and permissions",
                "Export material lists for procurement"
              ].map((feature, idx) => (
      ...
      <section className="px-4 md:px-8 py-20">
        <div className="max-w-[1200px] mx-auto">
          ...
          >
            Why Studios Choose Material Library
          </motion.h2>
      ...
      <section className="px-4 md:px-8 py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          >
            Start streamlining your material specification workflow today
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
